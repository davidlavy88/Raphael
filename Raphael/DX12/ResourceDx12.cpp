...
raphael::graphics::ResourceDx12::ResourceDx12(DeviceDx12* device, const ResourceDesc& desc)
...
raphael::graphics::ResourceDx12::~ResourceDx12()
{

}

void raphael::graphics::ResourceDx12::createBuffer(const ResourceDesc& desc)
{
...
void raphael::graphics::ResourceDx12::createTexture2D(const ResourceDesc& desc)
{
    CD3DX12_HEAP_PROPERTIES heapProp;
