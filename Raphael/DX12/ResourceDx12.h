...
namespace raphael
{
    ...
    public:
        ...
        ResourceView getResourceView(ResourceBindFlags viewType, DescriptorHandle descriptorHandle = {}, UINT strideInBytes = 0, DXGI_FORMAT formatOverride = DXGI_FORMAT_UNKNOWN);
        ResourceBindFlags getResourceBindFlags() const { return m_desc.bindFlags; }

        void initAsCbv(D3D12_CPU_DESCRIPTOR_HANDLE handle);
        void initAsSrv(D3D12_CPU_DESCRIPTOR_HANDLE handle, DXGI_FORMAT formatOverride = DXGI_FORMAT_UNKNOWN);
