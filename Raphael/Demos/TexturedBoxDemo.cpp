...
void TexturedBoxImGui::Display()
{
    ImGui::Begin("Textured Box Demo");
    ImGui::Text("Textured Box render");
    ImGui::End();
}
...
bool TexturedBoxDemo::Initialize(WindowInfo windowInfo)
{
...
// 4. Create swap chain and depth buffer
void TexturedBoxDemo::CreateSwapChainAndDepthBuffer(WindowInfo windowInfo)
{
...
void TexturedBoxDemo::Resize(unsigned int width, unsigned int height)
{
